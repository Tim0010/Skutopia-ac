...
export default function TermsOfService() {
  return (
    <PublicLayout
      ...
      subtitle="Last updated: April 5, 2024"
    >
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.1 }}
        className="prose prose-base md:prose-lg dark:prose-invert max-w-4xl mx-auto p-4 md:p-6 bg-white dark:bg-gray-800/30 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700/50"
      >
        <h2>1. Introduction</h2>
        <p>
          Welcome to Skutopia Academy ("we," "our," or "us"). These Terms of Service ("Terms") govern your access to and use of the Skutopia Academy website, mobile applications, and services (collectively, the "Services").
        </p>
        <p>
        ...
        <p>
          The Services and their contents, features, and functionality are owned by Skutopia Academy and are protected by copyright, trademark, and other intellectual property laws. You may not use, reproduce, distribute, modify, or create derivative works of our Services or any content contained therein without our express written consent.
        </p>
        ...
        <p>
          IN NO EVENT SHALL Skutopia Academy BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING WITHOUT LIMITATION, LOSS OF PROFITS, DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, RESULTING FROM YOUR ACCESS TO OR USE OF OR INABILITY TO ACCESS OR USE THE SERVICES.
        </p>
        ...
        <p>
          Skutopia Academy<br />
          Kabanana, Off Mai Chola Road<br />
          Lusaka, Zambia<br />
          Email: contact@skutopia-academia.com
        </p>
      </motion.div>
    </PublicLayout>
  );
