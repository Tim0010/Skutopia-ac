...
export default function CookiePolicy() {
  return (
    <PublicLayout
      title="Cookie Policy"
      subtitle="Last updated: April 5, 2025"
    >
      <motion.div
      ...
      >
        ...
        <p>
          This Cookie Policy explains how Skutopia Academy ("we," "our," or "us") uses cookies and similar technologies on our website, mobile applications, and services (collectively, the "Services"). This policy provides you with information about how we use cookies, what types of cookies we use, and how you can control them.
        </p>
